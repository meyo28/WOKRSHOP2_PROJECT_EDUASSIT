...
--
-- Host: 127.0.0.1:3301
-- Generation Time: Jun 25, 2026 at 06:59 PM
...
(24, 'HTML & CSS Reflection', 'Write a reflection on what you have learned about HTML and CSS so far. Include examples of elements you have used and challenges you faced.', '2026-06-24 01:46:00', '2026-06-24 01:57:00', '', 14, 9, NULL, '[{\"original_name\":\"GRADE_1.pdf\",\"server_path\":\"uploads\\/references\\/6a3ac643ea02e_GRADE_1.pdf\"}]', '2026-06-23 17:45:39', 0, 0),
(25, 'Basic Python Program', 'Write a Python program that accepts user input for two numbers and outputs their sum, difference, product, and quotient. Handle division by zero.', '2026-06-24 01:47:00', '2026-06-24 01:50:00', 'code', 14, 9, NULL, '[{\"original_name\":\"deanreport.pdf\",\"server_path\":\"uploads\\/references\\/6a3ac66485226_deanreport.pdf\"}]', '2026-06-23 17:46:12', 0, 0),
(29, 'HTML & CSS Reflection', 'Write a Python program that accepts user input for two numbers and outputs their sum, difference, product, and quotient. Handle division by zero.', '2026-06-24 08:52:00', '2026-06-24 09:00:00', 'essay', 7, 11, NULL, NULL, '2026-06-24 00:51:37', 0, 0),
(30, 'PROPOSAL PROJECT', 'WRITE INTRODUCTION ABOUT THE PROJECT', '2026-06-24 11:42:00', '2026-06-24 11:54:00', 'essay', 7, 11, NULL, '[{\"original_name\":\"deanreport.pdf\",\"server_path\":\"uploads\\/references\\/6a3b51e2e6961_deanreport.pdf\"}]', '2026-06-24 03:41:22', 0, 0);
...
(52, 25, 21, 'student', 'What is the difference between a list and a tuple in Python? I keep getting confused.', '2026-06-23 18:58:33'),
(53, 25, 21, 'ai', 'Don\'t worry, it\'s an easy concept to grasp. In simple terms, both lists and tuples are used to store multiple values in a single variable. The key difference lies in their mutability.\n\nThink of a list like a shopping list that you can modify - you can add or remove items from it. On the other hand, a tuple is like a sealed box that contains items - once it\'s created, you can\'t change what\'s inside.\n\nHere\'s a simple example to illustrate the difference:\n```python\n# A list (mutable)\nmy_list = [1, 2, 3]\nmy_list[0] = 10  # You can modify the list\nprint(my_list)  # Output: [10, 2, 3]\n\n# A tuple (immutable)\nmy_tuple = (1, 2, 3)\n# my_tuple[0] = 10  # This would raise an error\nprint(my_tuple)  # Output: (1, 2, 3)\n```\nA small first step you can try is creating a list and a tuple with the same values, and then trying to modify each one. See how Python responds to your attempts to change the values.\n\nTry this approach and see what happens.', '2026-06-23 18:58:35'),
(54, 25, 21, 'student', 'How do I center a div in CSS? I\'ve tried everything and it\'s not working.', '2026-06-23 18:59:10'),
(55, 25, 21, 'ai', 'To center a div in CSS, you can use several methods, but one common approach is to use the `margin` property. \n\nHowever, it seems like you\'re encountering an error. Let\'s try to debug it.\n\n1. The error message likely means that there\'s a mismatch in your CSS code, possibly due to incorrect syntax or missing properties.\n2. Common causes of this error include missing or mismatched brackets, semicolons, or incorrect property values.\n3. Here\'s a small code example showing the correct pattern: \n```css\n.div-center {\n  margin: 0 auto;\n  width: 50%; /* or any specific width */\n}\n```\n   Alternatively, you can use flexbox:\n```css\n.container {\n  display: flex;\n  justify-content: center;\n}\n\n.div-center {\n  width: 50%; /* or any specific width */\n}\n```\n4. To fix the issue, you should check your CSS code, particularly the lines where you\'re trying to center the div. Look for any syntax errors, missing semicolons, or incorrect property values.\n\nCheck your code at the line mentioned. Does it match the pattern shown?', '2026-06-23 18:59:11'),
(56, 26, 21, 'student', 'what is this cout<<\"hai\"<<endl; ?', '2026-06-24 00:34:35'),
(57, 26, 21, 'ai', 'The line of code `cout<<\"hai\"<<endl;` is a statement in C++ that prints the string \"hai\" to the console, followed by a newline character.\n\n**Explanation:**\n- `cout` is an object of the `ostream` class, which is used to output data to the console.\n- `<<` is the insertion operator, which is used to insert the string \"hai\" into the output stream.\n- `\"hai\"` is the string that is being printed to the console.\n- `endl` is a manipulator that inserts a newline character and flushes the buffer, which means it forces the output to be displayed immediately.\n\n**Example Code:**\n```cpp\n#include <iostream>\nusing namespace std;\n\nint main() {\n    cout << \"hai\" << endl;\n    return 0;\n}\n```\n**Important Syntax and Logic:**\n- The `#include <iostream>` directive is necessary to include the iostream standard file, which allows input/output operations.\n- The `using namespace std;` directive is used to avoid having to use the `std::` prefix before standard library elements like `cout`.\n- The `cout` object is used with the insertion operator `<<` to output data.\n- The `endl` manipulator is used to insert a newline character and flush the buffer.\n\nNow try writing your own version based on this example.', '2026-06-24 00:34:36'),
(58, 27, 21, 'student', 'write me an essay about AI', '2026-06-24 03:51:11'),
(59, 27, 21, 'ai', 'Let\'s start with a potential essay structure. You could begin by introducing the concept of Artificial Intelligence (AI) and its growing presence in our daily lives. For instance, you might discuss how AI-powered virtual assistants, like Siri or Alexa, are changing the way we interact with technology.\n\nA possible opening paragraph could look like this: \"Artificial Intelligence, a field that was once considered the realm of science fiction, has become an integral part of our modern world. From self-driving cars to personalized product recommendations, AI is revolutionizing the way we live, work, and communicate.\"\n\nWhen exploring the main body of the essay, consider discussing the benefits and challenges associated with AI. For example, you could examine how AI is improving healthcare outcomes by analyzing medical data, or how it\'s enhancing customer service through chatbots. However, you might also want to touch on the potential risks, such as job displacement or bias in AI decision-making.\n\nTo add some depth to your essay, think about incorporating examples of AI applications in various industries, such as finance, education, or transportation. This could help illustrate the versatility and impact of AI.\n\nNow, what specific aspect of AI would you like to focus on in your essay, and how do you think you can use these ideas to craft a compelling argument?', '2026-06-24 03:51:12'),
(60, 27, 21, 'student', 'can you give exanple less than 100 words', '2026-06-24 03:52:12'),
(61, 27, 21, 'ai', 'Let\'s consider a simple math problem. Think about breaking it down into smaller steps, like a recipe. For example, if you\'re trying to find the area of a rectangle, you might start by identifying the length and width, and then look for a formula to combine them. What\'s the first step you would take to solve a similar problem?', '2026-06-24 03:52:14');
...
(25, 21, 'What is the difference between a list and a tuple ...', '2026-06-23 18:58:33', '2026-06-23 18:59:11'),
(26, 21, 'what is this cout<<\"hai\"<<endl; ?', '2026-06-24 00:34:35', '2026-06-24 00:34:36'),
(27, 21, 'write me an essay about AI', '2026-06-24 03:51:11', '2026-06-24 03:52:14');
...
(13, 'SQL Programming', 'BITD1034', 'BITD-DB1', 40, '2026-01-03 00:00:00', 6),
...
(23, 25, 72, 'import React, { useState, useEffect } from \'react\';\r\nimport \'./TodoApp.css\';\r\n\r\nconst TodoApp = () => {\r\n  const [todos, setTodos] = useState([]);\r\n  const [inputValue, setInputValue] = useState(\'\');\r\n  const [filter, setFilter] = useState(\'all\');\r\n\r\n  useEffect(() => {\r\n    const storedTodos = localStorage.getItem(\'todos\');\r\n    if (storedTodos) {\r\n      setTodos(JSON.parse(storedTodos));\r\n    }\r\n  }, []);\r\n\r\n  useEffect(() => {\r\n    localStorage.setItem(\'todos\', JSON.stringify(todos));\r\n  }, [todos]);\r\n\r\n  const addTodo = () => {\r\n    if (inputValue.trim() !== \'\') {\r\n      const newTodo = {\r\n        id: Date.now(),\r\n        text: inputValue.trim(),\r\n        completed: false,\r\n        createdAt: new Date().toISOString()\r\n      };\r\n      setTodos([...todos, newTodo]);\r\n      setInputValue(\'\');\r\n    }\r\n  };\r\n\r\n  const toggleTodo = (id) => {\r\n    setTodos(todos.map(todo =>\r\n      todo.id === id ? { ...todo, completed: !todo.completed } : todo\r\n    ));\r\n  };\r\n\r\n  const deleteTodo = (id) => {\r\n    setTodos(todos.filter(todo => todo.id !== id));\r\n  };\r\n\r\n  const getFilteredTodos = () => {\r\n    switch(filter) {\r\n      case \'active\':\r\n        return todos.filter(todo => !todo.completed);\r\n      case \'completed\':\r\n        return todos.filter(todo => todo.completed);\r\n      default:\r\n        return todos;\r\n    }\r\n  };\r\n\r\n  const getPendingCount = () => {\r\n    return todos.filter(todo => !todo.completed).length;\r\n  };\r\n\r\n  return (\r\n    <div className=\"todo-app\">\r\n      <h1>Todo List</h1>\r\n      \r\n      <div className=\"input-section\">\r\n        <input\r\n          type=\"text\"\r\n          value={inputValue}\r\n          onChange={(e) => setInputValue(e.target.value)}\r\n          onKeyPress={(e) => e.key === \'Enter\' && addTodo()}\r\n          placeholder=\"Add a new task...\"\r\n        />\r\n        <button onClick={addTodo}>Add</button>\r\n      </div>\r\n\r\n      <div className=\"filter-section\">\r\n        <button \r\n          className={filter === \'all\' ? \'active\' : \'\'}\r\n          onClick={() => setFilter(\'all\')}\r\n        >\r\n          All\r\n        </button>\r\n        <button \r\n          className={filter === \'active\' ? \'active\' : \'\'}\r\n          onClick={() => setFilter(\'active\')}\r\n        >\r\n          Active\r\n        </button>\r\n        <button \r\n          className={filter === \'completed\' ? \'active\' : \'\'}\r\n          onClick={() => setFilter(\'completed\')}\r\n        >\r\n          Completed\r\n        </button>\r\n      </div>\r\n\r\n      <ul className=\"todo-list\">\r\n        {getFilteredTodos().map(todo => (\r\n          <li key={todo.id} className={todo.completed ? \'completed\' : \'\'}>\r\n            <span onClick={() => toggleTodo(todo.id)}>\r\n              {todo.text}\r\n            </span>\r\n            <button onClick={() => deleteTodo(todo.id)}>Delete</button>\r\n          </li>\r\n        ))}\r\n      </ul>\r\n\r\n      <div className=\"stats\">\r\n        <span>{getPendingCount()} pending tasks</span>\r\n      </div>\r\n    </div>\r\n  );\r\n};\r\n\r\nexport default TodoApp;', 'EXAMPLE_CODE_1.txt', '2026-06-23 17:47:04', NULL, NULL);
...
(29, 7, 11, 'penyelaras', 'GROUP A', 1, NULL, '2026-06-22 05:22:40', 50),
...
(33, 11, 9, 'pensyarah', 'Group A', 0, NULL, '2026-06-24 03:33:27', 50);
...
(54, 24, 72, 'Modern JavaScript frameworks have revolutionized the way web applications are developed and maintained. Frameworks such as React, Angular, and Vue.js have introduced component-based architecture, which allows developers to build reusable UI components that encapsulate both logic and presentation. This paradigm shift from traditional MVC (Model-View-Controller) patterns to component-based development has significantly improved code maintainability and scalability in large-scale projects.\r\n\r\nOne of the most significant advantages of modern frameworks is the virtual DOM implementation, pioneered by React. The virtual DOM allows efficient updates by minimizing direct manipulation of the actual DOM, resulting in improved performance for dynamic applications. Instead of re-rendering the entire page when state changes, frameworks intelligently calculate the minimal set of changes needed and apply only those updates.\r\n\r\nState management has also evolved dramatically with frameworks. Libraries like Redux and Vuex provide predictable state containers that make application state easier to track and debug. The concept of unidirectional data flow ensures that data changes are predictable and traceable, reducing bugs caused by unpredictable state mutations. This has been particularly beneficial for complex applications with multiple interacting components.\r\n\r\nServer-side rendering (SSR) and static site generation (SSG) are another area where modern frameworks excel. Next.js for React and Nuxt.js for Vue have made it straightforward to implement SSR, improving SEO performance and initial page load times. These frameworks also support hybrid approaches where some pages are pre-rendered while others are rendered on demand, offering flexibility in performance optimization.\r\n\r\nHowever, modern frameworks do come with challenges. The learning curve can be steep, especially when dealing with build tools, routing, and state management simultaneously. Bundle size can also become an issue, requiring careful code splitting and optimization. Despite these challenges, the ecosystem around these frameworks continues to grow, with extensive tooling, comprehensive documentation, and vibrant community support making them the preferred choice for contemporary web development.', 'EXAMPLE_ESSAY_1.txt', '2026-06-23 17:46:56', NULL, NULL),
(56, 29, 21, 'Modern JavaScript frameworks have revolutionized the way web applications are developed and maintained. Frameworks such as React, Angular, and Vue.js have introduced component-based architecture, which allows developers to build reusable UI components that encapsulate both logic and presentation. This paradigm shift from traditional MVC (Model-View-Controller) patterns to component-based development has significantly improved code maintainability and scalability in large-scale projects.\r\n\r\nOne of the most significant advantages of modern frameworks is the virtual DOM implementation, pioneered by React. The virtual DOM allows efficient updates by minimizing direct manipulation of the actual DOM, resulting in improved performance for dynamic applications. Instead of re-rendering the entire page when state changes, frameworks intelligently calculate the minimal set of changes needed and apply only those updates.\r\n\r\nState management has also evolved dramatically with frameworks. Libraries like Redux and Vuex provide predictable state containers that make application state easier to track and debug. The concept of unidirectional data flow ensures that data changes are predictable and traceable, reducing bugs caused by unpredictable state mutations. This has been particularly beneficial for complex applications with multiple interacting components.\r\n\r\nServer-side rendering (SSR) and static site generation (SSG) are another area where modern frameworks excel. Next.js for React and Nuxt.js for Vue have made it straightforward to implement SSR, improving SEO performance and initial page load times. These frameworks also support hybrid approaches where some pages are pre-rendered while others are rendered on demand, offering flexibility in performance optimization.\r\n\r\nHowever, modern frameworks do come with challenges. The learning curve can be steep, especially when dealing with build tools, routing, and state management simultaneously. Bundle size can also become an issue, requiring careful code splitting and optimization. Despite these challenges, the ecosystem around these frameworks continues to grow, with extensive tooling, comprehensive documentation, and vibrant community support making them the preferred choice for contemporary web development.', 'EXAMPLE_ESSAY_1.txt', '2026-06-24 00:52:10', 'B', 80.00);
INSERT INTO `essay_submission` (`id`, `assignment_id`, `student_id`, `essay`, `file_name`, `submitted_at`, `final_grade`, `total_score`) VALUES
(57, 29, 22, 'Modern JavaScript frameworks have revolutionized web development practices significantly. Frameworks such as React, Angular, and Vue.js introduced component-based architecture, enabling developers to build reusable UI components that combine both logic and presentation. This shift from traditional MVC patterns to component-based development has greatly improved code maintainability and scalability for large projects.\r\n\r\nA key advantage of modern frameworks is the virtual DOM implementation, first introduced by React. The virtual DOM enables efficient updates by reducing direct DOM manipulation, leading to better performance in dynamic applications. Instead of re-rendering the entire page on state changes, frameworks calculate the minimal needed changes and apply only those updates.\r\n\r\nState management has also evolved substantially. Libraries like Redux and Vuex offer predictable state containers making application state easier to track and debug. The unidirectional data flow concept ensures data changes are predictable and traceable, reducing bugs from unpredictable state mutations. This benefits complex applications with multiple interacting components.\r\n\r\nServer-side rendering and static site generation are other areas where frameworks excel. Next.js for React and Nuxt.js for Vue simplify SSR implementation, improving SEO and initial load times. These frameworks support hybrid approaches with some pages pre-rendered and others rendered on demand.\r\n\r\nDespite benefits, modern frameworks present challenges. The learning curve can be significant, especially with build tools, routing, and state management. Bundle size requires careful optimization. However, the growing ecosystem with extensive tooling, documentation, and community support makes them preferred for contemporary web development.', 'EXAMPLE_ESSAY_2.txt', '2026-06-24 00:55:02', NULL, NULL),
(58, 29, 23, 'Responsive web design has become essential in modern web development, with frameworks playing a crucial role in implementing responsive layouts. CSS frameworks like Bootstrap, Tailwind CSS, and Foundation have simplified the process of creating responsive interfaces by providing pre-built components and utility classes. These frameworks typically use a grid system based on flexbox or CSS Grid, allowing developers to create flexible layouts that adapt to different screen sizes.\r\n\r\nModern JavaScript frameworks like React and Vue.js have embraced component-based architecture, which has transformed web development practices. The virtual DOM concept, pioneered by React, enables efficient updates and improved performance. State management tools such as Redux provide predictable state containers for complex applications.\r\n\r\nServer-side rendering capabilities in frameworks like Next.js and Nuxt.js have improved SEO and initial load times. However, developers must consider the learning curve and bundle size optimization when adopting these technologies. The ecosystem continues to evolve with extensive tooling and community support.\r\n\r\nThe approach to responsive design has evolved with CSS Grid Layout and flexbox becoming standard. CSS Grid offers powerful two-dimensional layout control, while flexbox excels at one-dimensional arrangements. Modern responsive techniques include using relative units like rem and vw/vh, along with the clamp() function for fluid typography. CSS custom properties (variables) enable dynamic theming and easier maintenance of design systems across large applications.', 'EXAMPLE_ESSAY_3.txt', '2026-06-24 00:55:19', NULL, NULL),
(59, 29, 24, 'Web security remains a critical concern in modern application development, with threats evolving alongside technological advancement. Cross-Site Scripting (XSS) attacks continue to be one of the most prevalent vulnerabilities, occurring when malicious scripts are injected into trusted websites. Modern frameworks have built-in protection against XSS by automatically escaping user input, but developers must remain vigilant with custom components that bypass these safeguards.\r\n\r\nCross-Site Request Forgery (CSRF) attacks represent another significant threat, where unauthorized commands are transmitted from a user that the web application trusts. Protection mechanisms like anti-CSRF tokens, SameSite cookies, and additional verification steps have become standard practices. Modern frameworks typically include CSRF protection, but proper implementation requires understanding the underlying mechanisms.\r\n\r\nAuthentication and authorization have evolved significantly, with JWT (JSON Web Tokens) and OAuth 2.0 becoming industry standards. Proper token management, including secure storage, refresh token rotation, and short-lived access tokens, is essential for maintaining security. Role-based access control (RBAC) provides granular authorization, while implementing the principle of least privilege limits potential damage from compromised accounts.\r\n\r\nSecurity headers such as Content Security Policy (CSP), X-Frame-Options, and Strict-Transport-Security provide additional protection layers. CSP is particularly effective at mitigating XSS attacks by controlling which resources the browser can load. Regular security audits, dependency scanning, and penetration testing should be integrated into the development lifecycle to identify vulnerabilities early. As threats continue to evolve, staying updated with security best practices and following the OWASP Top 10 recommendations remains essential for web developers.', 'EXAMPLE_ESSAY_4.txt', '2026-06-24 00:59:33', NULL, NULL),
(60, 30, 21, 'Modern JavaScript frameworks have revolutionized the way web applications are developed and maintained. Frameworks such as React, Angular, and Vue.js have introduced component-based architecture, which allows developers to build reusable UI components that encapsulate both logic and presentation. This paradigm shift from traditional MVC (Model-View-Controller) patterns to component-based development has significantly improved code maintainability and scalability in large-scale projects.\r\n\r\nOne of the most significant advantages of modern frameworks is the virtual DOM implementation, pioneered by React. The virtual DOM allows efficient updates by minimizing direct manipulation of the actual DOM, resulting in improved performance for dynamic applications. Instead of re-rendering the entire page when state changes, frameworks intelligently calculate the minimal set of changes needed and apply only those updates.\r\n\r\nState management has also evolved dramatically with frameworks. Libraries like Redux and Vuex provide predictable state containers that make application state easier to track and debug. The concept of unidirectional data flow ensures that data changes are predictable and traceable, reducing bugs caused by unpredictable state mutations. This has been particularly beneficial for complex applications with multiple interacting components.\r\n\r\nServer-side rendering (SSR) and static site generation (SSG) are another area where modern frameworks excel. Next.js for React and Nuxt.js for Vue have made it straightforward to implement SSR, improving SEO performance and initial page load times. These frameworks also support hybrid approaches where some pages are pre-rendered while others are rendered on demand, offering flexibility in performance optimization.\r\n\r\nHowever, modern frameworks do come with challenges. The learning curve can be steep, especially when dealing with build tools, routing, and state management simultaneously. Bundle size can also become an issue, requiring careful code splitting and optimization. Despite these challenges, the ecosystem around these frameworks continues to grow, with extensive tooling, comprehensive documentation, and vibrant community support making them the preferred choice for contemporary web development.', 'EXAMPLE_ESSAY_1.txt', '2026-06-24 03:54:19', NULL, NULL);
...
(1, 'B032420001', '238c1060f3783b9df35f844d0426ceb5', 'Ahmad Fikri Bin Abdullahi', 'ahmad.fikri@student.utem.edu.my', 'BITS', '011-2345678', '2026-01-05 01:00:00'),
...
(73, 'B032430001', '238c1060f3783b9df35f844d0426ceb5', 'Muhammad Danish Bin Harun', 'muhammad.danish@student.utem.edu.my', 'BITS', '011-2345111', '2026-06-24 03:29:19'),
(74, 'B032430002', '238c1060f3783b9df35f844d0426ceb5', 'Nur Alia Binti Kamaruddin', 'nur.alia@student.utem.edu.my', 'BITS', '011-3456222', '2026-06-24 03:29:19'),
(75, 'B032430003', '238c1060f3783b9df35f844d0426ceb5', 'Amir Fakhri Bin Zulkifli', 'amir.fakhri@student.utem.edu.my', 'BITS', '011-4567333', '2026-06-24 03:29:19'),
(76, 'B032430004', '238c1060f3783b9df35f844d0426ceb5', 'Fatin Nur Aina Binti Azman', 'fatin.nur@student.utem.edu.my', 'BITS', '011-5678444', '2026-06-24 03:29:19'),
(77, 'B032430005', '238c1060f3783b9df35f844d0426ceb5', 'Hariz Bin Mahmod', 'hariz.mahmod@student.utem.edu.my', 'BITS', '011-6789555', '2026-06-24 03:29:19'),
(78, 'B032430006', '238c1060f3783b9df35f844d0426ceb5', 'Rania Binti Shamsuddin', 'rania.shamsud@student.utem.edu.my', 'BITS', '011-7890666', '2026-06-24 03:29:20'),
(79, 'B032430007', '238c1060f3783b9df35f844d0426ceb5', 'Afiq Zuhairi Bin Norazlan', 'afiq.zuhairi@student.utem.edu.my', 'BITS', '011-8901777', '2026-06-24 03:29:20'),
(80, 'B032430008', '238c1060f3783b9df35f844d0426ceb5', 'Hani Sofea Binti Mustafa', 'hani.sofea@student.utem.edu.my', 'BITS', '011-9012888', '2026-06-24 03:29:20'),
(81, 'B032430009', '238c1060f3783b9df35f844d0426ceb5', 'Radzi Bin Ismail', 'radzi.ismail@student.utem.edu.my', 'BITS', '012-0123999', '2026-06-24 03:29:20'),
(82, 'B032430010', '238c1060f3783b9df35f844d0426ceb5', 'Auni Zulaikha Binti Rosli', 'auni.zulaikha@student.utem.edu.my', 'BITS', '012-1234000', '2026-06-24 03:29:20'),
(83, 'B032430101', '238c1060f3783b9df35f844d0426ceb5', 'Iman Syafiqa Binti Abdul Ghani', 'iman.syafiqa@student.utem.edu.my', 'BITD', '012-2345111', '2026-06-24 03:29:20'),
(84, 'B032430102', '238c1060f3783b9df35f844d0426ceb5', 'Luqman Hakim Bin Yusoff', 'luqman.hakim@student.utem.edu.my', 'BITD', '012-3456222', '2026-06-24 03:29:20'),
(85, 'B032430103', '238c1060f3783b9df35f844d0426ceb5', 'Najihah Binti Fauzi', 'najihah.fauzi@student.utem.edu.my', 'BITD', '012-4567333', '2026-06-24 03:29:20'),
(86, 'B032430104', '238c1060f3783b9df35f844d0426ceb5', 'Zikri Bin Azhar', 'zikri.azhar@student.utem.edu.my', 'BITD', '012-5678444', '2026-06-24 03:29:20'),
(87, 'B032430105', '238c1060f3783b9df35f844d0426ceb5', 'Husna Binti Salleh', 'husna.salleh@student.utem.edu.my', 'BITD', '012-6789555', '2026-06-24 03:29:20'),
(88, 'B032430106', '238c1060f3783b9df35f844d0426ceb5', 'Irham Bin Mahadi', 'irham.mahadi@student.utem.edu.my', 'BITD', '012-7890666', '2026-06-24 03:29:20'),
(89, 'B032430107', '238c1060f3783b9df35f844d0426ceb5', 'Najwa Binti Ridzuan', 'najwa.ridzuan@student.utem.edu.my', 'BITD', '012-8901777', '2026-06-24 03:29:20'),
(90, 'B032430108', '238c1060f3783b9df35f844d0426ceb5', 'Azzam Bin Fadillah', 'azzam.fadillah@student.utem.edu.my', 'BITD', '012-9012888', '2026-06-24 03:29:20'),
(91, 'B032430109', '238c1060f3783b9df35f844d0426ceb5', 'Sabrina Binti Ishak', 'sabrina.ishak@student.utem.edu.my', 'BITD', '013-0123999', '2026-06-24 03:29:20'),
(92, 'B032430110', '238c1060f3783b9df35f844d0426ceb5', 'Firdaus Bin Mat Saad', 'firdaus.saad@student.utem.edu.my', 'BITD', '013-1234000', '2026-06-24 03:29:20');
